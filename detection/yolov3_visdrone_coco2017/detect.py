...
def detect(
	...
	##cheak time 
        ...
        cheak_model= (time.time() - t1)
        cheak_model_load += cheak_model
    ...
    print('Finish_Done:(%.3fs)' %(cheak_time /300))
    print('Finish_model_load:(%.3fs)' %(cheak_model_load /300))
    if save_images:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--images', type=str, default='/data2/AIChallenge/avi', help='path to images')
