...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--data-cfg', type=str, default='/home/adasone/KJS/CenterNet/data/coco.data',
        ...
        self.add_new_params(self.parser)
    ...
    def add_new_params(parser):
        ...
        # Re-Identification
        # ******************************************************************************************************************
        parser.add_argument('-a', '--reid-arch', type=str, default='resnet50')
        ...
        # Counting
        # ******************************************************************************************************************
        parser.add_argument('--save-vid', dest='save_vid',
                            default='.', type=str)
